...
# ========================================       SkodaL_HAR_DATA               =============================
class SkodaL_HAR_DATA(BASE_DATA):
    ...
    def __init__(self, args):
        ...
        super(SkodaL_HAR_DATA, self).__init__(args)

    def load_all_the_data(self, root_path):
        print(" ----------------------- load all the data -------------------")

        data_dict = sio.loadmat(file_name=os.path.join(root_path,"left_classall_clean.mat"), squeeze_me=True)
        ...
        df_all = df_all[list(df_all.columns[1:-1])+["sub","activity_id"]]
