...
# TODO V1 and V2
# ========================================       HuGaDB_HAR_DATA             =============================
class HuGaDB_HAR_DATA(BASE_DATA):
    ...
    def __init__(self, args):
        super(HuGaDB_HAR_DATA, self).__init__(args)
        """
        ...
        self.train_keys   = [1, 2, 3, 6, 7, 8, 11, 12, 13, 16, 17, 18]
        self.vali_keys    = [4,9,14]
        self.test_keys    = [5,10,15]

        self.drop_activities = []

        # In Dataset V1, there is no 12:sitting in the car
        # In Dataset V2, there is no 9:bicycling
